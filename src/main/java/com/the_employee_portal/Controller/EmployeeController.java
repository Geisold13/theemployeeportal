...
public class EmployeeController {
    ...
    @PutMapping("/{id}/photo")
    public ResponseEntity<?> updateEmployeePhoto(@PathVariable Long id, @RequestParam("photo") MultipartFile photo) throws IOException {

        employeeService.updateEmployeePhoto(id, photo);
